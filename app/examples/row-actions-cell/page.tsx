  ...
  return (
    <>
      ...
      <Txt>
        ...
        <InternalLink to="/examples/handling-cell-clicks">cell click</InternalLink> handler is not enough, implementing
        a row actions cell using the column <Code>render</Code> function should’t be difficult.
      </Txt>
      ...
      <Txt info title="Heads up">
        ...
        <Code>click</Code> event on the actions and{' '}
