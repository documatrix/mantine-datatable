...
export default async function RTLSupportExamplePage() {
  ...
  return (
    <>
      <PageTitle of={PATH} />
      <Txt>
        Since <strong>v8.3.9</strong>, {PRODUCT_NAME} fully supports RTL (Right-to-Left) layouts, making it suitable for
        languages like Arabic, Hebrew, Persian, and Urdu. When wrapped in Mantine&apos;s <Code>DirectionProvider</Code>,
        all DataTable features automatically adapt to the text direction. See the{' '}
